...
public class AddItemModifier extends LootModifier {
	...
	public static final Codec<AddItemModifier> CODEC = RecordCodecBuilder.create(i -> codecStart(i).and(i.group(
			...
			Codec.STRING.optionalFieldOf("chance").forGetter(m -> Optional.ofNullable(m.chance).map(DoubleConfigValue::toData))
	...
	protected AddItemModifier(LootItemCondition[] conditionsIn, Item item, Optional<String> chance) {
		super(conditionsIn);
		this.item = item;
